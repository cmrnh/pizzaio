...
socket.io server as `/socket.io/socket.controller.js`. Alternatively you can
serve the file `socket.controller.js` found at the root of this repository.

```html
<script src="/socket.io/socket.controller.js"></script>
<script>
